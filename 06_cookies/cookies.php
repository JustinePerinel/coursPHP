<?php 
    ...
    // 3 - envoie du cookie avec l'info sur la langue dedans
            ...
            <main class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <!-- 1/ ON envoie la langue choisie par l'url : la valeur fr par exemple est récupérée dans la superglobale $_GET -->
